...
package stdint_h is
  ...
  -- Largest integral types.   
   subtype intmax_t is aarch64_linux_gnu_bits_types_h.uu_intmax_t;  -- /usr/include/stdint.h:90

   subtype uintmax_t is aarch64_linux_gnu_bits_types_h.uu_uintmax_t;  -- /usr/include/stdint.h:91
