...
package MQTT_Library is
   ...
   -- Taken from aarch64_linux_gnu_bits_stdint_uintn_h
   subtype uint8_t is unsigned_char;
   subtype uint16_t is short;
   subtype uint32_t is unsigned;

   LIBMOSQUITTO_MAJOR : constant := 2;  --  /usr/include/mosquitto.h:67
   LIBMOSQUITTO_MINOR : constant := 0;  --  /usr/include/mosquitto.h:68
   LIBMOSQUITTO_REVISION : constant := 21;  --  /usr/include/mosquitto.h:69
   LIBMOSQUITTO_VERSION_NUMBER : constant :=
     LIBMOSQUITTO_MAJOR*1000000+LIBMOSQUITTO_MINOR*1000+LIBMOSQUITTO_REVISION;

   MOSQ_LOG_NONE : constant := 0;  --  /usr/include/mosquitto.h:74
   MOSQ_LOG_INFO : constant := (2**0);  --  /usr/include/mosquitto.h:75
   MOSQ_LOG_NOTICE : constant := (2**1);  --  /usr/include/mosquitto.h:76
   MOSQ_LOG_WARNING : constant := (2**2);  --  /usr/include/mosquitto.h:77
   MOSQ_LOG_ERR : constant := (2**3);  --  /usr/include/mosquitto.h:78
   MOSQ_LOG_DEBUG : constant := (2**4);  --  /usr/include/mosquitto.h:79
   MOSQ_LOG_SUBSCRIBE : constant := (2**5);  --  /usr/include/mosquitto.h:80
   MOSQ_LOG_UNSUBSCRIBE : constant := (2**6);  --  /usr/include/mosquitto.h:81
   MOSQ_LOG_WEBSOCKETS : constant := (2**7);  --  /usr/include/mosquitto.h:82
   MOSQ_LOG_INTERNAL : constant := 16#80000000#;  --  /usr/include/mosquitto.h:83
   MOSQ_LOG_ALL : constant := 16#FFFFFFFF#;  --  /usr/include/mosquitto.h:84

   MOSQ_MQTT_ID_MAX_LENGTH : constant := 23;  --  /usr/include/mosquitto.h:151

   MQTT_PROTOCOL_V31 : constant := 3;  --  /usr/include/mosquitto.h:153
   MQTT_PROTOCOL_V311 : constant := 4;  --  /usr/include/mosquitto.h:154
   MQTT_PROTOCOL_V5 : constant := 5;  --  /usr/include/mosquitto.h:155
  ...
  -- * Integer values returned from many libmosquitto functions.  
   ...
   MOSQ_ERR_AUTH_CONTINUE : constant mosq_err_t := -4;
   MOSQ_ERR_NO_SUBSCRIBERS : constant mosq_err_t := -3;
   MOSQ_ERR_SUB_EXISTS : constant mosq_err_t := -2;
   ...
   MOSQ_ERR_PROXY : constant mosq_err_t := 16;
   MOSQ_ERR_PLUGIN_DEFER : constant mosq_err_t := 17;
   MOSQ_ERR_MALFORMED_UTF8 : constant mosq_err_t := 18;
   MOSQ_ERR_KEEPALIVE : constant mosq_err_t := 19;
   MOSQ_ERR_LOOKUP : constant mosq_err_t := 20;
   MOSQ_ERR_MALFORMED_PACKET : constant mosq_err_t := 21;
   MOSQ_ERR_DUPLICATE_PROPERTY : constant mosq_err_t := 22;
   MOSQ_ERR_TLS_HANDSHAKE : constant mosq_err_t := 23;
   MOSQ_ERR_QOS_NOT_SUPPORTED : constant mosq_err_t := 24;
   MOSQ_ERR_OVERSIZE_PACKET : constant mosq_err_t := 25;
   MOSQ_ERR_OCSP : constant mosq_err_t := 26;
   MOSQ_ERR_TIMEOUT : constant mosq_err_t := 27;
   MOSQ_ERR_RETAIN_NOT_SUPPORTED : constant mosq_err_t := 28;
   MOSQ_ERR_TOPIC_ALIAS_INVALID : constant mosq_err_t := 29;
   MOSQ_ERR_ADMINISTRATIVE_ACTION : constant mosq_err_t := 30;
   MOSQ_ERR_ALREADY_EXISTS : constant mosq_err_t := 31;  -- /usr/include/mosquitto.h:88
  ...
  --  
   ...
   MOSQ_OPT_PROTOCOL_VERSION : constant mosq_opt_t := 1;
   MOSQ_OPT_SSL_CTX : constant mosq_opt_t := 2;
   MOSQ_OPT_SSL_CTX_WITH_DEFAULTS : constant mosq_opt_t := 3;
   MOSQ_OPT_RECEIVE_MAXIMUM : constant mosq_opt_t := 4;
   MOSQ_OPT_SEND_MAXIMUM : constant mosq_opt_t := 5;
   MOSQ_OPT_TLS_KEYFORM : constant mosq_opt_t := 6;
   MOSQ_OPT_TLS_ENGINE : constant mosq_opt_t := 7;
   MOSQ_OPT_TLS_ENGINE_KPASS_SHA1 : constant mosq_opt_t := 8;
   MOSQ_OPT_TLS_OCSP_REQUIRED : constant mosq_opt_t := 9;
   MOSQ_OPT_TLS_ALPN : constant mosq_opt_t := 10;
   MOSQ_OPT_TCP_NODELAY : constant mosq_opt_t := 11;
   MOSQ_OPT_BIND_ADDRESS : constant mosq_opt_t := 12;
   MOSQ_OPT_TLS_USE_OS_CERTS : constant mosq_opt_t := 13;  -- /usr/include/mosquitto.h:133
  ...
  --  
   ...
   type mosquitto_message is record
      mid : aliased int;  -- /usr/include/mosquitto.h:176
      topic : Interfaces.C.Strings.chars_ptr;  -- /usr/include/mosquitto.h:177
      payload : System.Address;  -- /usr/include/mosquitto.h:178
      payloadlen : aliased int;  -- /usr/include/mosquitto.h:179
      qos : aliased int;  -- /usr/include/mosquitto.h:180
      retain : aliased Extensions.bool;  -- /usr/include/mosquitto.h:181
   end record
   with Convention => C_Pass_By_Copy;  -- /usr/include/mosquitto.h:175

   type mosquitto is null record;   -- incomplete struct

   type mqtt5_u_property is null record;   -- incomplete struct

   subtype mosquitto_property is mqtt5_u_property;  -- /usr/include/mosquitto.h:185
  ...
  --  
   ...
   function mosquitto_lib_version
     (major : access int;
      minor : access int;
      revision : access int) return int  -- /usr/include/mosquitto.h:248
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   function mosquitto_lib_init return int  -- /usr/include/mosquitto.h:264
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   function mosquitto_lib_cleanup return int  -- /usr/include/mosquitto.h:277
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   function mosquitto_new
     (id : Interfaces.C.Strings.chars_ptr;
      ...
      obj : System.Address) return access mosquitto  -- /usr/include/mosquitto.h:314
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   procedure mosquitto_destroy (mosq : access mosquitto)  -- /usr/include/mosquitto.h:327
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   function mosquitto_reinitialise
     (mosq : access mosquitto;
      id : Interfaces.C.Strings.chars_ptr;
      clean_session : Extensions.bool;
      obj : System.Address) return int  -- /usr/include/mosquitto.h:357
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   function mosquitto_will_set
     (mosq : access mosquitto;
      ...
      qos : int;
      retain : Extensions.bool) return int  -- /usr/include/mosquitto.h:392
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   function mosquitto_will_set_v5
     (mosq : access mosquitto;
      ...
      properties : access mosquitto_property) return int  -- /usr/include/mosquitto.h:436
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   function mosquitto_will_clear (mosq : access mosquitto) return int  -- /usr/include/mosquitto.h:451
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   function mosquitto_username_pw_set
     (mosq : access mosquitto;
      ...
      password : Interfaces.C.Strings.chars_ptr) return int  -- /usr/include/mosquitto.h:480
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   function mosquitto_connect
     (mosq : access mosquitto;
      ...
      port : int;
      keepalive : int) return int  -- /usr/include/mosquitto.h:520
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   function mosquitto_connect_bind
     (mosq : access mosquitto;
      ...
      port : int;
      keepalive : int;
      bind_address : Interfaces.C.Strings.chars_ptr) return int  -- /usr/include/mosquitto.h:551
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   function mosquitto_connect_bind_v5
     (mosq : access mosquitto;
      ...
      properties : access constant mosquitto_property) return int  -- /usr/include/mosquitto.h:603
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   function mosquitto_connect_async
     (mosq : access mosquitto;
      host : Interfaces.C.Strings.chars_ptr;
      port : int;
      keepalive : int) return int  -- /usr/include/mosquitto.h:634
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   function mosquitto_connect_bind_async
     (mosq : access mosquitto;
      ...
      port : int;
      keepalive : int;
      bind_address : Interfaces.C.Strings.chars_ptr) return int  -- /usr/include/mosquitto.h:676
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   function mosquitto_connect_srv
     (mosq : access mosquitto;
      host : Interfaces.C.Strings.chars_ptr;
      keepalive : int;
      bind_address : Interfaces.C.Strings.chars_ptr) return int  -- /usr/include/mosquitto.h:715
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   function mosquitto_reconnect (mosq : access mosquitto) return int  -- /usr/include/mosquitto.h:742
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   function mosquitto_reconnect_async (mosq : access mosquitto) return int  -- /usr/include/mosquitto.h:769
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   function mosquitto_disconnect (mosq : access mosquitto) return int  -- /usr/include/mosquitto.h:788
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   function mosquitto_disconnect_v5
     (mosq : access mosquitto;
      reason_code : int;
      properties : access constant mosquitto_property) return int  -- /usr/include/mosquitto.h:820
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   function mosquitto_publish
     (mosq : access mosquitto;
      ...
      payload : System.Address;
      qos : int;
      retain : Extensions.bool) return int  -- /usr/include/mosquitto.h:872
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   function mosquitto_publish_v5
     (mosq : access mosquitto;
      ...
      qos : int;
      retain : Extensions.bool;
      properties : access constant mosquitto_property) return int  -- /usr/include/mosquitto.h:928
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   function mosquitto_subscribe
     (mosq : access mosquitto;
      ...
      qos : int) return int  -- /usr/include/mosquitto.h:966
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   function mosquitto_subscribe_v5
     (mosq : access mosquitto;
      ...
      qos : int;
      options : int;
      properties : access constant mosquitto_property) return int  -- /usr/include/mosquitto.h:1009
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   function mosquitto_subscribe_multiple
     (mosq : access mosquitto;
      ...
      qos : int;
      options : int;
      properties : access constant mosquitto_property) return int  -- /usr/include/mosquitto.h:1044
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   function mosquitto_unsubscribe
     (mosq : access mosquitto;
      mid : access int;
      sub : Interfaces.C.Strings.chars_ptr) return int  -- /usr/include/mosquitto.h:1068
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   function mosquitto_unsubscribe_v5
     (mosq : access mosquitto;
      mid : access int;
      sub : Interfaces.C.Strings.chars_ptr;
      properties : access constant mosquitto_property) return int  -- /usr/include/mosquitto.h:1113
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   function mosquitto_unsubscribe_multiple
     (mosq : access mosquitto;
      ...
      sub_count : int;
      sub : System.Address;
      properties : access constant mosquitto_property) return int  -- /usr/include/mosquitto.h:1144
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   function mosquitto_message_copy (dst : access mosquitto_message; src : access constant mosquitto_message) return int  -- /usr/include/mosquitto.h:1170
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   procedure mosquitto_message_free (message : System.Address)  -- /usr/include/mosquitto.h:1183
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   procedure mosquitto_message_free_contents (message : access mosquitto_message)  -- /usr/include/mosquitto.h:1196
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   function mosquitto_loop_forever
     (mosq : access mosquitto;
      timeout : int;
      max_packets : int) return int  -- /usr/include/mosquitto.h:1248
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   function mosquitto_loop_start (mosq : access mosquitto) return int  -- /usr/include/mosquitto.h:1268
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   function mosquitto_loop_stop (mosq : access mosquitto; force : Extensions.bool) return int  -- /usr/include/mosquitto.h:1292
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   function mosquitto_loop
     (mosq : access mosquitto;
      timeout : int;
      max_packets : int) return int  -- /usr/include/mosquitto.h:1339
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   function mosquitto_loop_read (mosq : access mosquitto; max_packets : int) return int  -- /usr/include/mosquitto.h:1374
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   function mosquitto_loop_write (mosq : access mosquitto; max_packets : int) return int  -- /usr/include/mosquitto.h:1404
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   function mosquitto_loop_misc (mosq : access mosquitto) return int  -- /usr/include/mosquitto.h:1428
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   function mosquitto_socket (mosq : access mosquitto) return int  -- /usr/include/mosquitto.h:1448
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   function mosquitto_want_write (mosq : access mosquitto) return Extensions.bool  -- /usr/include/mosquitto.h:1461
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   function mosquitto_threaded_set (mosq : access mosquitto; threaded : Extensions.bool) return int  -- /usr/include/mosquitto.h:1478
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   function mosquitto_opts_set
     (mosq : access mosquitto;
      option : mosq_opt_t;
      value : System.Address) return int  -- /usr/include/mosquitto.h:1524
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   function mosquitto_int_option
     (mosq : access mosquitto;
      option : mosq_opt_t;
      value : int) return int  -- /usr/include/mosquitto.h:1582
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   function mosquitto_string_option
     (mosq : access mosquitto;
      option : mosq_opt_t;
      value : Interfaces.C.Strings.chars_ptr) return int  -- /usr/include/mosquitto.h:1623
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   function mosquitto_void_option
     (mosq : access mosquitto;
      option : mosq_opt_t;
      value : System.Address) return int  -- /usr/include/mosquitto.h:1646
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   function mosquitto_reconnect_delay_set
     (mosq : access mosquitto;
      ...
      reconnect_exponential_backoff : Extensions.bool) return int  -- /usr/include/mosquitto.h:1683
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   function mosquitto_max_inflight_messages_set (mosq : access mosquitto; max_inflight_messages : unsigned) return int  -- /usr/include/mosquitto.h:1711
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   procedure mosquitto_message_retry_set (mosq : access mosquitto; message_retry : unsigned)  -- /usr/include/mosquitto.h:1718
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   procedure mosquitto_user_data_set (mosq : access mosquitto; obj : System.Address)  -- /usr/include/mosquitto.h:1734
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   function mosquitto_userdata (mosq : access mosquitto) return System.Address  -- /usr/include/mosquitto.h:1746
   with Import => True, 
        Convention => C, 
     ...
     (mosq : access mosquitto;
      ...
      pw_callback : access function
        (arg1 : Interfaces.C.Strings.chars_ptr;
         arg2 : int;
         arg3 : int;
         arg4 : System.Address) return int) return int  -- /usr/include/mosquitto.h:1802
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   function mosquitto_tls_insecure_set (mosq : access mosquitto; value : Extensions.bool) return int  -- /usr/include/mosquitto.h:1832
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   function mosquitto_tls_opts_set
     (mosq : access mosquitto;
      ...
      ciphers : Interfaces.C.Strings.chars_ptr) return int  -- /usr/include/mosquitto.h:1866
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   function mosquitto_tls_psk_set
     (mosq : access mosquitto;
      ...
      ciphers : Interfaces.C.Strings.chars_ptr) return int  -- /usr/include/mosquitto.h:1893
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   function mosquitto_ssl_get (mosq : access mosquitto) return System.Address  -- /usr/include/mosquitto.h:1910
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   procedure mosquitto_connect_callback_set (mosq : access mosquitto; on_connect : access procedure
        (arg1 : access mosquitto;
         arg2 : System.Address;
         arg3 : int))  -- /usr/include/mosquitto.h:1937
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   procedure mosquitto_connect_with_flags_callback_set (mosq : access mosquitto; on_connect : access procedure
        (arg1 : access mosquitto;
         arg2 : System.Address;
         arg3 : int;
         arg4 : int))  -- /usr/include/mosquitto.h:1959
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   procedure mosquitto_connect_v5_callback_set (mosq : access mosquitto; on_connect : access procedure
        (arg1 : access mosquitto;
         ...
         arg3 : int;
         arg4 : int;
         arg5 : access constant mosquitto_property))  -- /usr/include/mosquitto.h:1987
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   procedure mosquitto_disconnect_callback_set (mosq : access mosquitto; on_disconnect : access procedure
        (arg1 : access mosquitto;
         arg2 : System.Address;
         arg3 : int))  -- /usr/include/mosquitto.h:2007
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   procedure mosquitto_disconnect_v5_callback_set (mosq : access mosquitto; on_disconnect : access procedure
        (arg1 : access mosquitto;
         arg2 : System.Address;
         arg3 : int;
         arg4 : access constant mosquitto_property))  -- /usr/include/mosquitto.h:2032
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   procedure mosquitto_publish_callback_set (mosq : access mosquitto; on_publish : access procedure
        (arg1 : access mosquitto;
         arg2 : System.Address;
         arg3 : int))  -- /usr/include/mosquitto.h:2058
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   procedure mosquitto_publish_v5_callback_set (mosq : access mosquitto; on_publish : access procedure
        (arg1 : access mosquitto;
         ...
         arg3 : int;
         arg4 : int;
         arg5 : access constant mosquitto_property))  -- /usr/include/mosquitto.h:2093
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   procedure mosquitto_message_callback_set (mosq : access mosquitto; on_message : access procedure
        (arg1 : access mosquitto;
         arg2 : System.Address;
         arg3 : access constant mosquitto_message))  -- /usr/include/mosquitto.h:2116
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   procedure mosquitto_message_v5_callback_set (mosq : access mosquitto; on_message : access procedure
        (arg1 : access mosquitto;
         ...
         arg4 : access constant mosquitto_property))  -- /usr/include/mosquitto.h:2144
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   procedure mosquitto_subscribe_callback_set (mosq : access mosquitto; on_subscribe : access procedure
        (arg1 : access mosquitto;
         ...
         arg3 : int;
         arg4 : int;
         arg5 : access int))  -- /usr/include/mosquitto.h:2165
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   procedure mosquitto_subscribe_v5_callback_set (mosq : access mosquitto; on_subscribe : access procedure
        (arg1 : access mosquitto;
         ...
         arg4 : int;
         arg5 : access int;
         arg6 : access constant mosquitto_property))  -- /usr/include/mosquitto.h:2191
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   procedure mosquitto_unsubscribe_callback_set (mosq : access mosquitto; on_unsubscribe : access procedure
        (arg1 : access mosquitto;
         arg2 : System.Address;
         arg3 : int))  -- /usr/include/mosquitto.h:2209
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   procedure mosquitto_unsubscribe_v5_callback_set (mosq : access mosquitto; on_unsubscribe : access procedure
        (arg1 : access mosquitto;
         arg2 : System.Address;
         arg3 : int;
         arg4 : access constant mosquitto_property))  -- /usr/include/mosquitto.h:2232
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   procedure mosquitto_log_callback_set (mosq : access mosquitto; on_log : access procedure
        (arg1 : access mosquitto;
         arg2 : System.Address;
         arg3 : int;
         arg4 : Interfaces.C.Strings.chars_ptr))  -- /usr/include/mosquitto.h:2255
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   function mosquitto_socks5_set
     (mosq : access mosquitto;
      ...
      port : int;
      username : Interfaces.C.Strings.chars_ptr;
      password : Interfaces.C.Strings.chars_ptr) return int  -- /usr/include/mosquitto.h:2280
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   function mosquitto_strerror (mosq_errno : int) return Interfaces.C.Strings.chars_ptr  -- /usr/include/mosquitto.h:2301
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   function mosquitto_connack_string (connack_code : int) return Interfaces.C.Strings.chars_ptr  -- /usr/include/mosquitto.h:2314
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   function mosquitto_reason_string (reason_code : int) return Interfaces.C.Strings.chars_ptr  -- /usr/include/mosquitto.h:2327
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   function mosquitto_string_to_command (str : Interfaces.C.Strings.chars_ptr; cmd : access int) return int  -- /usr/include/mosquitto.h:2348
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   function mosquitto_sub_topic_tokenise
     (subtopic : Interfaces.C.Strings.chars_ptr;
      ...
      count : access int) return int  -- /usr/include/mosquitto.h:2404
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   function mosquitto_sub_topic_tokens_free (topics : System.Address; count : int) return int  -- /usr/include/mosquitto.h:2422
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   function mosquitto_topic_matches_sub
     (sub : Interfaces.C.Strings.chars_ptr;
      topic : Interfaces.C.Strings.chars_ptr;
      result : access Extensions.bool) return int  -- /usr/include/mosquitto.h:2445
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   function mosquitto_topic_matches_sub2
     (sub : Interfaces.C.Strings.chars_ptr;
      ...
      topic : Interfaces.C.Strings.chars_ptr;
      topiclen : size_t;
      result : access Extensions.bool) return int  -- /usr/include/mosquitto.h:2471
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   function mosquitto_pub_topic_check (topic : Interfaces.C.Strings.chars_ptr) return int  -- /usr/include/mosquitto.h:2496
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   function mosquitto_pub_topic_check2 (topic : Interfaces.C.Strings.chars_ptr; topiclen : size_t) return int  -- /usr/include/mosquitto.h:2522
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   function mosquitto_sub_topic_check (topic : Interfaces.C.Strings.chars_ptr) return int  -- /usr/include/mosquitto.h:2550
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   function mosquitto_sub_topic_check2 (topic : Interfaces.C.Strings.chars_ptr; topiclen : size_t) return int  -- /usr/include/mosquitto.h:2579
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   function mosquitto_validate_utf8 (str : Interfaces.C.Strings.chars_ptr; len : int) return int  -- /usr/include/mosquitto.h:2597
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   type libmosquitto_will is record
      topic : Interfaces.C.Strings.chars_ptr;  -- /usr/include/mosquitto.h:2608
      payload : System.Address;  -- /usr/include/mosquitto.h:2609
      payloadlen : aliased int;  -- /usr/include/mosquitto.h:2610
      qos : aliased int;  -- /usr/include/mosquitto.h:2611
      retain : aliased Extensions.bool;  -- /usr/include/mosquitto.h:2612
   end record
   with Convention => C_Pass_By_Copy;  -- /usr/include/mosquitto.h:2607

   type libmosquitto_auth is record
      username : Interfaces.C.Strings.chars_ptr;  -- /usr/include/mosquitto.h:2616
      password : Interfaces.C.Strings.chars_ptr;  -- /usr/include/mosquitto.h:2617
   end record
   with Convention => C_Pass_By_Copy;  -- /usr/include/mosquitto.h:2615

   type libmosquitto_tls is record
      cafile : Interfaces.C.Strings.chars_ptr;  -- /usr/include/mosquitto.h:2621
      capath : Interfaces.C.Strings.chars_ptr;  -- /usr/include/mosquitto.h:2622
      certfile : Interfaces.C.Strings.chars_ptr;  -- /usr/include/mosquitto.h:2623
      keyfile : Interfaces.C.Strings.chars_ptr;  -- /usr/include/mosquitto.h:2624
      ciphers : Interfaces.C.Strings.chars_ptr;  -- /usr/include/mosquitto.h:2625
      tls_version : Interfaces.C.Strings.chars_ptr;  -- /usr/include/mosquitto.h:2626
      pw_callback : access function
           (arg1 : Interfaces.C.Strings.chars_ptr;
            arg2 : int;
            arg3 : int;
            arg4 : System.Address) return int;  -- /usr/include/mosquitto.h:2627
      cert_reqs : aliased int;  -- /usr/include/mosquitto.h:2628
   end record
   with Convention => C_Pass_By_Copy;  -- /usr/include/mosquitto.h:2620
  ...
  --  
   ...
   function mosquitto_subscribe_simple
     (messages : System.Address;
      ...
      tls : access constant libmosquitto_tls) return int  -- /usr/include/mosquitto.h:2668
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   function mosquitto_subscribe_callback
     (callback : access function
      ...
      password : Interfaces.C.Strings.chars_ptr;
      will : access constant libmosquitto_will;
      tls : access constant libmosquitto_tls) return int  -- /usr/include/mosquitto.h:2721
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   function mosquitto_property_add_byte
     (proplist : System.Address;
      identifier : int;
      value : uint8_t) return int  -- /usr/include/mosquitto.h:2767
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   function mosquitto_property_add_int16
     (proplist : System.Address;
      identifier : int;
      value : uint16_t) return int  -- /usr/include/mosquitto.h:2791
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   function mosquitto_property_add_int32
     (proplist : System.Address;
      identifier : int;
      value : uint32_t) return int  -- /usr/include/mosquitto.h:2815
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   function mosquitto_property_add_varint
     (proplist : System.Address;
      identifier : int;
      value : uint32_t) return int  -- /usr/include/mosquitto.h:2839
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   function mosquitto_property_add_binary
     (proplist : System.Address;
      ...
      len : uint16_t) return int  -- /usr/include/mosquitto.h:2864
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   function mosquitto_property_add_string
     (proplist : System.Address;
      identifier : int;
      value : Interfaces.C.Strings.chars_ptr) return int  -- /usr/include/mosquitto.h:2889
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   function mosquitto_property_add_string_pair
     (proplist : System.Address;
      ...
      value : Interfaces.C.Strings.chars_ptr) return int  -- /usr/include/mosquitto.h:2915
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   function mosquitto_property_identifier (property : access constant mosquitto_property) return int  -- /usr/include/mosquitto.h:2930
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   function mosquitto_property_next (proplist : access constant mosquitto_property) return access constant mosquitto_property  -- /usr/include/mosquitto.h:2954
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   function mosquitto_property_read_byte
     (proplist : access constant mosquitto_property;
      identifier : int;
      value : access uint8_t;
      skip_first : Extensions.bool) return access constant mosquitto_property  -- /usr/include/mosquitto.h:2996
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   function mosquitto_property_read_int16
     (proplist : access constant mosquitto_property;
      identifier : int;
      value : access uint16_t;
      skip_first : Extensions.bool) return access constant mosquitto_property  -- /usr/include/mosquitto.h:3021
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   function mosquitto_property_read_int32
     (proplist : access constant mosquitto_property;
      identifier : int;
      value : access uint32_t;
      skip_first : Extensions.bool) return access constant mosquitto_property  -- /usr/include/mosquitto.h:3046
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   function mosquitto_property_read_varint
     (proplist : access constant mosquitto_property;
      identifier : int;
      value : access uint32_t;
      skip_first : Extensions.bool) return access constant mosquitto_property  -- /usr/include/mosquitto.h:3071
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   function mosquitto_property_read_binary
     (proplist : access constant mosquitto_property;
      ...
      value : System.Address;
      len : access uint16_t;
      skip_first : Extensions.bool) return access constant mosquitto_property  -- /usr/include/mosquitto.h:3098
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   function mosquitto_property_read_string
     (proplist : access constant mosquitto_property;
      identifier : int;
      value : System.Address;
      skip_first : Extensions.bool) return access constant mosquitto_property  -- /usr/include/mosquitto.h:3127
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   function mosquitto_property_read_string_pair
     (proplist : access constant mosquitto_property;
      ...
      name : System.Address;
      value : System.Address;
      skip_first : Extensions.bool) return access constant mosquitto_property  -- /usr/include/mosquitto.h:3157
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   procedure mosquitto_property_free_all (properties : System.Address)  -- /usr/include/mosquitto.h:3177
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   function mosquitto_property_copy_all (dest : System.Address; src : access constant mosquitto_property) return int  -- /usr/include/mosquitto.h:3191
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   function mosquitto_property_check_command (command : int; identifier : int) return int  -- /usr/include/mosquitto.h:3206
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   function mosquitto_property_check_all (command : int; properties : access constant mosquitto_property) return int  -- /usr/include/mosquitto.h:3229
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   function mosquitto_property_identifier_to_string (identifier : int) return Interfaces.C.Strings.chars_ptr  -- /usr/include/mosquitto.h:3245
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   function mosquitto_string_to_property_info
     (propname : Interfaces.C.Strings.chars_ptr;
      ...
      c_type : access int) return int  -- /usr/include/mosquitto.h:3270
   with Import => True, 
        Convention => C, 
